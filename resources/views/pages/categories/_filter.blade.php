<div class="w-full sm:w-1/3 md:w-1/4 lg:w-1/5">
    <div class="categoriesList">
        ...
        <ul class="mt-5 space-y-3">
            <li>
                ...
                <a href="{{ route('categories.show', 'category-1') }}" class="ml-1 text-blue-500 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Category 1">Category 1</a>
            </li>
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
    ...
    <div class="brandsList my-8">
        ...
        <ul class="mt-5 space-y-3">
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
                <a href="#" class="ml-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Brand 1">Brand 1</a>
            </li>
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
                <a href="#" class="ml-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Brand 2">Brand 2</a>
            </li>
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
                <a href="#" class="ml-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Brand 3">Brand 3</a>
            </li>
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
                <a href="#" class="ml-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Brand 4">Brand 4</a>
            </li>
            <li>
                <span class="text-xs text-gray-400"><i class="fas fa-chevron-right"></i></span>
                <a href="#" class="ml-1 text-gray-400 hover:text-blue-500 focus:text-blue-500 focus:outline-none transition ease-in-out duration-150" title="Filter products by Brand 5">Brand 5</a>
            </li>
        </ul>
    </div>
