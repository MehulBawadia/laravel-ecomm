    ...
    <section class="latestOrders mt-8 pt-16">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mx-4">
                ...
                <div>
                    <button class="linkAddNewCoupon bg-indigo-500 text-sm text-gray-50 py-2 px-3 rounded focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 tracking-wider font-medium"><i class="fas fa-plus text-xs"></i> Add New</button>
                </div>
            </div>

            @include('admin.coupons._create')

            <div class="bg-white rounded-md shadow mx-4 mt-3 overflow-x-auto couponsTable">
