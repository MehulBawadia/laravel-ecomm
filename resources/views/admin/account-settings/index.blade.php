            ...
            <div class="w-full mt-3 bg-gray-50 rounded shadow overflow-hidden">
                <form action="{{ route('admin.accountSettings.general') }}" method="POST" id="formUpdateGeneralInfo" enctype="multipart/form-data">
                    ...
                    <div class="bg-gray-50 px-4 py-4">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="linkCancel ml-3 border border-gray-300 bg-transparent text-gray-500 py-2 px-3 rounded hover:text-gray-600 hover:border-gray-600 focus:text-gray-600 focus:border-gray-600 focus:outline-none focus:bg-white tracking-wider" title="Cancel">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
