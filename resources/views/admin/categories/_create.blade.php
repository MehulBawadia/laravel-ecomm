        ...
        <form action="#" method="POST" id="formAddCategory">
            ...
            <div class="flex mt-5">
                ...
                <div class="mt-7 ml-5 w-1/2">
                    <button type="submit" class="w-36 bg-indigo-500 text-gray-50 py-2 px-3 rounded focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 tracking-wider font-medium">Add</button>
