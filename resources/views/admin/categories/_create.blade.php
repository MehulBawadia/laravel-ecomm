<div id="sectionAddNewCategory" class="overflow-hidden hidden bg-white rounded-md shadow mx-4 mt-3">
    <div class="bg-gray-50 px-4 py-2">
        <h2>Add New Category</h2>
    </div>

    <div class="p-4">
        <p class="text-red-400 text-sm tracking-wider">You will be redirected to the Edit Category page once you click on Add button.</p>

        <form action="{{ route('admin.categories.store') }}" method="POST" id="formAddCategory">
            @csrf
            ...
            <div class="flex mt-5">
                ...
                <div class="mt-7 ml-5 w-1/2">
                    <button type="submit" class="w-36 bg-indigo-500 text-gray-50 py-2 px-3 rounded focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 tracking-wider font-medium btnAddCategory">Add</button>
