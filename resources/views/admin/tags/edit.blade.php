...
@section('pageTitle')
    <div class="flex items-end">
        <ul class="flex text-sm gap-2">
            ...
            <li>/</li>
            <li><a href="{{ route('admin.tags') }}" class="text-blue-500 hover:text-blue-600 focus:text-blue-600 focus:outline-none transition ease-in-out duration-150" title="Go to Dashboard Page">Tags</a></li>
            <li>/</li>
        </ul>
