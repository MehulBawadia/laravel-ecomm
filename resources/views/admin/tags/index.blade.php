    ...
    <section class="latestOrders my-12">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mx-4">
                ...
                <div>
                    <button class="linkAddNewTag bg-blue-500 text-sm text-gray-50 py-2 px-3 rounded focus:outline-none hover:bg-blue-600 focus:bg-blue-600 tracking-wider font-medium"><i class="fas fa-plus text-xs"></i> Add New</button>
                </div>
            </div>
