...
@section('pageTitle')
    <div class="flex items-end">
        ...
        <h1 class="text-2xl font-Rubik font-bold uppercase tracking-wide leading-none ml-3">Tags</h1>
    </div>
@endsection
    ...
    <section class="latestOrders mt-8 pt-16">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mx-4">
                ...
                <div>
                    <button class="linkAddNewTag bg-indigo-500 text-sm text-gray-50 py-2 px-3 rounded focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 tracking-wider font-medium"><i class="fas fa-plus text-xs"></i> Add New</button>
                </div>
            </div>
...
@section('pageScripts')
    <script>
        ...
        $('.linkAddNewTag').on('click', function (e) {
            e.preventDefault();

            $('#sectionAddNewTag').slideDown().removeClass('hidden').addClass('transition ease-in-out duration-150');
        ...
        $('.linkCancel').on('click', function(e) {
            ...
            $('#sectionAddNewTag').slideUp().addClass('hidden').removeClass('transition ease-in-out duration-150');
