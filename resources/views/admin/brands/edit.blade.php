...
@section('title')
    <title>Edit: Brand 1 | {{ config('app.name') }}</title>
@endsection
...
@section('pageTitle')
    <div class="flex items-end">
        <ul class="flex text-sm gap-2">
            ...
            <li>/</li>
            <li><a href="{{ route('admin.brands') }}" class="text-indigo-600 text-sm tracking-wider hover:text-indigo-800 focus:text-indigo-800 focus:outline-none transition ease-in-out duration-150" title="Go to Dashboard Page">Brands</a></li>
            <li>/</li>
        </ul>

        <h1 class="text-2xl font-Rubik font-bold uppercase tracking-wide leading-none ml-3">Edit: Brand 1</h1>
    </div>
@endsection
...
@section('content')
    <section class="generalInformation mt-8 pt-16 px-6">
        <div class="container mx-auto">
            ...
            @include('admin.brands._general_info')
        </div>
    </section>
    ...
    <section class="seoSection my-16 px-5">
        <div class="container mx-auto">
            ...
            @include('admin.brands._seo_details')
        </div>
    </section>
@endsection
