    ...
    <div class="container mx-auto">
        <div class="flex flex-col sm:flex-row items-center justify-between py-8 px-4 text-sm">
            ...
            <div class="mt-5 sm:mt-0 relative">
                <input type="search" class="rounded py-2 pl-8 w-64 sm:w-96 focus:outline-none" placeholder="Search" />

                <div class="absolute top-0 left-0 mt-3 ml-2 text-gray-400"><i class="fas fa-search"></i></div>
            </div>
