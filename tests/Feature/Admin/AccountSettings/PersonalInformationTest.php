...
class PersonalInformationTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->patchRouteUrl = route('admin.accountSettings.general');
    ...
    /** @test */
    public function admin_can_delete_the_uploaded_avatar_image_file()
    {
        $this->withoutExceptionHandling();
        ...
        $this->delete(route('admin.accountSettings.deleteAvatar', auth()->id()))
            ->assertJson([
                'status'   => 'success',
                'title'    => 'Success !',
